...
interface ITeacherRepository {
     ...
     * @return 1 if inserted, 0 otherwise
     */
    fun addHistoryTeacher(teacher: Teacher, dateOfChanging:LocalDateTime): Int
     ...
     * @return 1 if updated, 0 otherwise
     */
    fun updateHistoryTeacher(teacher: Teacher, dateOfChanging:LocalDateTime): Int
     ...
     */
    fun getHistoryTeacher(id: UUID, dateOfChanging: LocalDateTime): Teacher?
